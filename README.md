...
Requires [Node.js](https://nodejs.org/) 20.19–20.x or 22.12+ (Vite 8 doesn't support Node 21 or 22.0–22.11; the devcontainer uses 22) and [Yarn](https://yarnpkg.com/).
